 ...
 * @author Stefano
 */
public class TestLogoutThread extends Thread{
    int res;
    
    TestLogoutThread(String name) throws NotBoundException{
        try {
            ...
            res = stub.logout(name);
            System.out.println(name + " "+this.getId()+" "+res);
        } catch (RemoteException ex) {
            Logger.getLogger(TestLogoutThread.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
